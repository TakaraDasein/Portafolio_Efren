...
export default function MachineLearning() {
  const expertise = [
    { category: "Supervised Learning", items: ["Regresión Lineal", "Random Forest", "SVM", "Neural Networks"] },
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-24 px-8 md:px-12 border-b border-white/10">
        ...
        >
          ...
          <h2 className="font-sans text-3xl md:text-5xl font-light italic mb-16">Frameworks y Librerías</h2>
      ...
      <section className="py-24 px-8 md:px-12 border-b border-white/10">
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4 text-center">05 — METODOLOGÍA</p>
          <h2 className="font-sans text-3xl md:text-5xl font-light italic mb-16 text-center">Pipeline de Desarrollo</h2>

          <div className="space-y-8">
            {[
              { step: "01", title: "Definición del Problema", desc: "Análisis de requisitos y objetivos del negocio" },
              { step: "02", title: "Preparación de Datos", desc: "Limpieza, transformación y feature engineering" },
              { step: "03", title: "Modelado", desc: "Selección y entrenamiento de algoritmos" },
              { step: "04", title: "Evaluación", desc: "Validación de métricas y optimización de hiperparámetros" },
              { step: "05", title: "Deployment", desc: "Implementación y monitoreo en producción" },
            ].map((phase, index) => (
              <motion.div
                key={phase.step}
