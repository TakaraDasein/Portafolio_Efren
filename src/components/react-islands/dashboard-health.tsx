...
const metricConfig = {
  weight: { icon: Weight, label: "Peso", unit: "kg", color: "text-cyan-500" },
  mood: { icon: Smile, label: "Estado de Ánimo", unit: "1-10", color: "text-amber-500" },
  sleep: { icon: Moon, label: "Sueño", unit: "hrs", color: "text-indigo-500" },
  exercise: { icon: Zap, label: "Ejercicio", unit: "min", color: "text-emerald-500" },
  meditation: { icon: Brain, label: "Meditación", unit: "min", color: "text-violet-500" },
  reading: { icon: BookOpen, label: "Lectura", unit: "min", color: "text-rose-500" },
    ...
    <div className="max-w-7xl mx-auto space-y-10">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-sans text-4xl font-light tracking-tight">
            Salud & <span className="italic text-cyan-500">Mente</span>
          </h1>
      ...
      >
        <h3 className="font-sans text-lg font-light mb-4">
          Registro de <span className="italic text-cyan-500">Hoy</span>
        </h3>
      ...
      <div>
        <h3 className="font-sans text-lg font-light mb-4">
          Historial <span className="italic text-cyan-500">Reciente</span>
        </h3>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h3 className="font-sans text-2xl font-light">
                  Nuevo <span className="italic text-cyan-500">Registro</span>
                </h3>
              ...
              <div className="flex gap-3 mt-8">
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-cyan-500 text-black font-mono text-xs tracking-wider hover:bg-cyan-400 transition-colors"
                >
                  GUARDAR
                </button>
                <button
