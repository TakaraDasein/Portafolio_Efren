...
const environmentProjects = [
  ...
  {
    id: "timeline-presidentes-colombia-1",
    title: "Línea de Tiempo de Presidentes de Colombia",
    description: "Aplicación interactiva para explorar de forma cronológica los periodos presidenciales en Colombia, facilitando el análisis histórico y territorial del poder político.",
    embedUrl: "https://1-colombian-presidents-timeline-end.vercel.app/",
    tags: ["Historia", "Territorial", "Política", "Timeline"],
    featured: false,
    thumbnail: "/proyectos/10.linea-presidents.jpeg",
    type: "web" as const
  },
  {
    id: "timeline-presidentes-colombia-2",
    title: "Índice de Riesgo Climático en Colombia",
    description: "Plataforma interactiva para explorar el índice de riesgo climático en Colombia, con enfoque territorial para identificar vulnerabilidades y priorizar acciones de adaptación.",
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <ProjectsShowcase 
        ...
        sectionNumber="03 • PORTAFOLIO SOCIO-AMBIENTAL"
        accentColor="#10b981"
      />
      ...
      <section className="py-24 px-8 md:px-12 border-b border-white/10">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">04 • ÁREAS DE IMPACTO</p>
