...
export default function Content() {
  const initiatives = [
    {
      title: "AnÃ¡lisis de Huella de Carbono",
      description: "Modelos predictivos para medir y reducir emisiones empresariales",
      impact: "30% reducciÃ³n promedio",
      icon: "ðŸŒ±",
    },
    {
      title: "OptimizaciÃ³n de Recursos HÃ­dricos",
      description: "Machine Learning para gestiÃ³n eficiente del agua en agricultura",
      impact: "40% ahorro de agua",
      icon: "ðŸ’§",
    },
    {
      title: "EnergÃ­as Renovables",
      description: "PredicciÃ³n de generaciÃ³n solar y eÃ³lica mediante IA",
      impact: "25% mejor rendimiento",
      icon: "âš¡",
    },
    {
      title: "Biodiversidad Urbana",
      description: "AnÃ¡lisis de datos para preservaciÃ³n de ecosistemas urbanos",
  ...
  const sdgs = [
    { number: 7, name: "EnergÃ­a Asequible y No Contaminante" },
    { number: 11, name: "Ciudades y Comunidades Sostenibles" },
    { number: 12, name: "ProducciÃ³n y Consumo Responsable" },
    { number: 13, name: "AcciÃ³n por el Clima" },
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] flex items-center justify-center border-b border-white/10">
        ...
        >
          ...
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">03 â€” IMPACTO SOSTENIBLE</p>
          ...
          <p className="font-mono text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
            Aplicando ciencia de datos para crear un futuro mÃ¡s sostenible y equitativo
          </p>
        </motion.div>
      ...
      <section className="py-24 px-8 md:px-12 border-b border-white/10">
        ...
        >
          <h2 className="font-sans text-3xl md:text-5xl font-light mb-8 leading-relaxed">
            ...
            UsÃ©moslos para proteger nuestro planeta y mejorar vidas.
          </h2>
      ...
      <section className="py-24 px-8 md:px-12 border-b border-white/10">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">04 â€” INICIATIVAS</p>
          <h2 className="font-sans text-3xl md:text-5xl font-light italic mb-16">Proyectos con PropÃ³sito</h2>
      ...
      <section className="py-24 px-8 md:px-12 border-b border-white/10">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">05 â€” ALINEACIÃ“N</p>
      ...
      <section className="py-24 px-8 md:px-12 border-b border-white/10">
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4 text-center">06 â€” IMPACTO MEDIBLE</p>
          <h2 className="font-sans text-3xl md:text-5xl font-light italic mb-16 text-center">NÃºmeros que Importan</h2>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: "12+", label: "Proyectos Sostenibles" },
              { value: "500T", label: "COâ‚‚ Reducido" },
