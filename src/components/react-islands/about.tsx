...
const statements = [
  ...
  "La visualizaci�n efectiva comunica historias ocultas.",
  "Cada m�trica cuenta una parte de la verdad.",
  "Los datos no mienten, solo necesitan interpretaci�n.",
  "El an�lisis predictivo anticipa el futuro.",
]
