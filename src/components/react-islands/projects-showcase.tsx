...
interface Project {
  ...
  featured?: boolean
  thumbnail: string
  type?: "tableau" | "powerbi" | "jupyter" | "github" | "demo" | "web"
  externalLink?: string
}
      ...
      case "powerbi":
        return (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 19h16M7 19V9m5 10V5m5 14v-8" />
          </svg>
        )
      case "jupyter":
        return (
      ...
      case "web":
        return (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12h18M12 3c2.5 2.5 2.5 15.5 0 18M12 3c-2.5 2.5-2.5 15.5 0 18"/>
          </svg>
        )
      default:
        return (
